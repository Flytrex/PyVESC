...
class VESCMessage(type):
    ...
    (format character) and the third optional element is a scalar that will be applied to the data upon unpack
    For more info on struct format characters see: https://docs.python.org/2/library/struct.html
    """
    _msg_registry = {}
    _endian_fmt = '>'
    _id_fmt = 'B'
